...
export default function CouponsTable() {
  const { coupons, saveCoupon, removeCoupon, isLoading } = useAdmin();
    ...
    <div className="space-y-6">
      <div className="flex justify-end">
        <button
          ...
          className="flex items-center gap-2 px-6 py-2.5 bg-ice-gradient text-black font-body font-bold uppercase tracking-widest text-sm rounded-sm hover:scale-105 transition-all active:scale-95"
        >
              ...
              {coupons.map((coupon) => (
                ...
                >
                  <td className="px-4 py-4">
                    <span className="font-mono text-sm font-bold text-ice-blue">
                      {coupon.code}
                    </span>
                  </td>
                  <td className="px-4 py-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 px-4 py-3 rounded-sm outline-none focus:border-ice-blue transition-all font-mono uppercase"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 px-4 py-3 rounded-sm outline-none focus:border-ice-blue transition-all font-mono"
                  />
                </div>
                <div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-4 bg-ice-gradient text-black font-bold uppercase tracking-[0.2em] rounded-sm hover:scale-[1.02] transition-all active:scale-[0.98] disabled:opacity-50 disabled:scale-100 flex items-center justify-center gap-2"
                >
