      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          >
            ...
            <span
              className="text-[10px] font-mono tracking-[0.3em] text-white/30 hidden sm:block mt-1 uppercase"
          ...
          <ul className="hidden md:flex items-center gap-8">
            {navLinks.map((link, i) => (
              ...
              >
                <a
                  href={link.href}
                  className="text-sm font-body font-600 tracking-[0.15em] text-white/60 hover:text-white
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={toggleCart}
              className="relative p-2 rounded-sm border border-white/10 bg-white/[0.03]
        ...
        {menuOpen && (
          <motion.div
            ...
            className="fixed top-0 left-0 right-0 z-40 pt-20 pb-8 px-6
                       bg-black/95 backdrop-blur-xl border-b border-white/[0.06] md:hidden"
          >
              ...
              {navLinks.map((link, i) => (
                ...
                >
                  <a
                    ...
                    className="flex items-center gap-4 py-3 border-b border-white/[0.05] group"
                  >
                    <span className="w-1 h-1 rounded-full bg-fire-orange group-hover:w-6 transition-all duration-300" />
                    <span
                      className="text-2xl font-display tracking-wider text-white/80 group-hover:text-white transition-colors"
                      style={{ fontFamily: "'Bebas Neue', Impact, sans-serif" }}
                    >
                      {link.label}
                    </span>
